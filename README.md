...
```sh
brew install --cask watahiki606/tap/padswitch
```

または [Releases](https://github.com/watahiki606/padswitch/releases) から zip をダウンロードして展開し、PadSwitch.app を「アプリケーション」フォルダへ移す。
